...
//           {
//             id: "b1",
//             question: "Tell me about a time when you had to meet a tight deadline for a project. How did you manage your time?",
//             type: "behavioral"
//           },
//           {
//             id: "b2",
//             question: "Describe a situation where you had to work with a difficult team member. How did you handle the situation?",
//             type: "behavioral"
//           },
//           {
//             id: "b3",
//             question: "Share an example of when you had to learn a new technology or skill quickly for a project. What approach did you take?",
//             type: "behavioral"
//           },
//           {
//             id: "b4",
//             question: "Tell me about a time when you received critical feedback. How did you respond to it?",
//             type: "behavioral"
//           },
//           {
//             id: "b5",
//             question: "Describe a project where you demonstrated leadership skills. What was your role and what was the outcome?",
//             type: "behavioral"
//           }
//         ],
//         technicalQuestions: [
...
//   }, [])
  ...
  useEffect(() => {
    if (job?.mockInterviewData) {
      try {
        const parsedData = typeof job.mockInterviewData === 'string' 
  ...
  const generateInterviewQuestions = async () => {
    ...
    try {
      const response = await axios.post(`http://localhost:3000/generate-interview/${jobID}`, {
        jobTitle: job.title,
        company: job.company,
    ...
    <div className="p-5 max-w-7xl mx-auto">
      ...
      {!interviewData ? (
        ...
        <div className="bg-gray-50 p-8 rounded-lg border border-gray-200 text-center">
          <p className="text-gray-600 mb-4">No interview questions have been generated for this job yet.</p>
          <button 
                  ...
                  <div className="pl-5 space-y-2">
                    {question.options?.map((option, optionIdx) => (
                      ...
                      >
                        ...
                        />
                        <span>{option}</span>
                        {showResults && optionIdx === question.correctAnswer && (
