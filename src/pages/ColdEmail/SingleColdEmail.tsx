...
const SingleColdEmail = () => {
    ...
    const generatecoldEmail = async () => {
        ...
        try {
         const response =  await axios.post(`http://localhost:3000/cold-email/${jobID}`);
         refetchJobs(); 
    ...
    if (!job) {
        return (
          <Loader message = "Loading Cold Email" />
        );
    }
        ...
        <div className="p-5 max-w-full mx-auto">
            ...
            {!coldEmail ? (
                <div className="bg-gray-50 p-8 rounded-lg border border-gray-200 text-center">
                    <p className="text-gray-600 mb-4">No cold Email has been created for this job yet.</p>
                    <button 
                    ...
                    >
                        {isGenerating ? (
                            ...
                            <>
                                ...
                                <SparklesIcon className="h-5 w-5 mr-2"  onClick={ generatecoldEmail}/>
                                Generate Cold Email
                                </>
