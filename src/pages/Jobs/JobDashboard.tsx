  ...
  return (
    <div className="p-4 md:p-8">
      ...
      <p className="text-lg md:text-xl text-center">
        Total number of jobs Tracked: {totalJobs}
      </p>
      {jobs.length > 0 ? (
        ...
        <p className="text-center text-gray-600 mt-10">
          No job data available to display analytics.
        </p>
      )}
    </div>
  );
